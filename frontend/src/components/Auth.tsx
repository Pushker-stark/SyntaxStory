import { SignupInput } from "@pndevs/medium-common";
        ...
        <div className="h-screen flex justify-center flex-col">
            <div className="flex justify-center">
                <div>
                    ...
                    <div className="pt-8">
                        {type === "signup" ? <LabelledInput label="Name" placeholder="Enter your name" onChange={
                            (e) => {
                                setBlogInputs({
                                    ...blogInputs,
                                    name: e.target.value
                        ...
                        <LabelledInput label="Username" placeholder="Enter your username" onChange={
                            (e) => {
                                setBlogInputs({
                                    ...blogInputs,
